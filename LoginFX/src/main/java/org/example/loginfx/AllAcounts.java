...
public class AllAcounts {
    ...
    public static void CreateSampleLogins(){
        User eggMan = new User("EggMan", "Ivo", "a1B2c3D4", (short) 1, (byte)1, "eggman.png");
        eggMan.bio = """
        ...
        User eggManNega = new User("Eggman-Nega", "Ivo (future)", "e5F6g7H8", (short) 2, (byte)1, "eggmanNega.png");
        eggManNega.bio = """
        ...
        User gerald = new User("Gerald173", "Gerald","i9J0k1l2", (short) 3, (byte)1, "geraldRobotnik.png");
        gerald.bio = """
